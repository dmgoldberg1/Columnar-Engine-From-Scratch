...
void CSVWrapper::SetScheme(Scheme& scheme, const std::vector<int64_t>& types, const std::vector<std::string>& column_names) {
    impl_->SetScheme(scheme, types, column_names);
}
