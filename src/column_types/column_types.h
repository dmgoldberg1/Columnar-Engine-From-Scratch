...
public:
    ...
    virtual void MergeHashes(std::vector<uint64_t>& hashes, std::vector<std::vector<std::string>>& group_name) const = 0;
...
public:
    ...
    int64_t GetSum(const std::vector<uint64_t>& mask) const;
    ...
    void MergeHashes(std::vector<uint64_t>& hashes, std::vector<std::vector<std::string>>& group_name) const override;
